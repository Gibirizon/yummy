...
<template>
    <div class="min-h-screen bg-gradient-to-r from-gray-900 via-gray-800 to-gray-700 py-8">
        <h2 class="mb-4 text-center text-2xl font-bold text-white sm:mb-12 sm:text-4xl lg:text-5xl">Our Recipes</h2>
        ...
        <section class="mb-8 sm:mb-16">
            <div class="mb-6 flex items-center justify-center">
                ...
                <h2 class="shadow-text text-xl font-semibold text-white sm:text-3xl">Popular Recipes</h2>
            </div>
        ...
        <section class="mb-8 sm:mb-16">
            <div class="mb-6 flex items-center justify-center">
                ...
                <h2 class="shadow-text text-xl font-semibold text-white sm:text-3xl">Breakfast</h2>
            </div>
        ...
        <section class="mb-8 sm:mb-16">
            <div class="mb-6 flex items-center justify-center">
                <Utensils class="mr-2 h-8 w-8 text-indigo-400" />
                <h2 class="shadow-text text-xl font-semibold text-white sm:text-3xl">Dinner</h2>
            </div>
