...
async function saveChanges() {
    ...
    await whoamiActor.value.update_user_by_index(id_from_route, newUsername.value);
    goToInfo();
}
...
<template>
    <div class="profile-edit flex min-h-screen w-full flex-col items-center justify-center bg-gray-900 p-8 text-white">
